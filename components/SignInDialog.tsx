  ...
  return (
    <div className="fixed inset-0 bg-black/30 text-black flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-xl max-w-md w-full">
        <h2 className="flex items-center justify-center text-2xl font-bold mb-4">Sign In</h2>
        ...
        <div className="space-y-3">
          ...
          <button 
            ...
            className="w-full flex items-center justify-center gap-3 py-2.5 px-4 bg-[#24292F] text-white rounded-lg hover:bg-[#1B1F23] transition-colors"
          >
